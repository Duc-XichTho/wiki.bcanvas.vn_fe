...
class BaoCaoGroupUnitCacheService {
    constructor() {
        this.cachePrefix = 'BaoCaoGroupUnit_';
        this.cacheTTL = 60;
    }

    generateCacheKey(params) {
        const { type, currentYearKTQT, currentCompanyKTQT } = params;
        const typePart = type || 'BaoCaoGroupUnit';
...
const baoCaoGroupUnitCacheService = new BaoCaoGroupUnitCacheService();
export default baoCaoGroupUnitCacheService;
