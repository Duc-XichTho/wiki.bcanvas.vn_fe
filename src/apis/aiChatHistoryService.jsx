...
const SUB_URL = '/api/ai-chat-history';
...
export const createChatHistory = async (chatData) => {
    try {
...
export const updateChatHistory = async (id, chatData) => {
    try {
        const { data } = await instance.put(`${URL}/${id}`, chatData);
        return data;
    } catch (error) {
