...
const SUB_URL = '/api/ai-free-chat-history';
const URL = BASE_URL + SUB_URL;

// Get all chat history for a user
export const getAllFreeChatHistory = async () => {
    try {
...
export const getAIFreeChatHistoryById = async (id) => {
    try {
...
export const createAIFreeChatHistory = async (data) => {
    try {
...
export const updateAIFreeChatHistory = async (data) => {
    try {
...
export const deleteAIFreeChatHistory = async (id) => {
    try {
