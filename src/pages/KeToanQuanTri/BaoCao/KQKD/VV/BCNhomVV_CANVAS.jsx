...
export default function BCNhomVV_CANVAS({ company }) {
    ...
    const tableStatusButton = 'BCNhomVVStatusButtonCanvas';
    ...
    useEffect(() => {
        prepareData();
    }, [selectedMonth, isShowAll1, isShowView, currentYearCanvas]);
            ...
            cellRenderer: (params) => {
                return (
                    <div className="cell-action-group">
                        <PopupCellActionBCKD {...params} field={field} allData={rowData} type={'VV'}
