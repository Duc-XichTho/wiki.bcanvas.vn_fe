...
export default function BaoCaoGroupUnit_CANVAS() {
  ...
  const tableStatusButton = 'BCGroupUnitStatusButtonCanvas';
  ...
  async function prepareData() {
    ...
    //     ? await getItemFromIndexedDB('BCNDV_2' + '_' + currentYearCanvas + '_' + companySelect)
    //     : await getItemFromIndexedDB('BCNDV_1' + '_' + currentYearCanvas + '_' + companySelect);
    let rowData = []
    ...
    //
    // if (isShowView2) {
    //     await setItemInIndexedDB('BCNDV_2' + '_' + currentYearCanvas + '_' + companySelect, rowData);
    // } else {
    //     await setItemInIndexedDB('BCNDV_1' + '_' + currentYearCanvas + '_' + companySelect, rowData);
    // }
    //
