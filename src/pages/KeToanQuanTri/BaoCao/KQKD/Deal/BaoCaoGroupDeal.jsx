...
export default function BaoCaoGroupDeal() {
  const table = 'BaoCaoGroupDeal';
  ...
  }, [table, isShowView, isShowView2, isShowAll1]);
  ...
  async function prepareData() {
    ...
    const uniqueGroups = [...new Set(units.map((unit) => unit.clientAccount))];
      ...
      <div style={{ display: 'flex' }}>
        <div style={{ flex: 1 }}>
          <div className="header-powersheet navbar_kqkd">
            <div className="navbar_title">
              <span className="text-header-bao-cao">
                Báo cáo KQKD Theo Nhóm Deal - {selectedMonth === 0 ? 'Luỹ kế năm' : 'Tháng ' + selectedMonth}
              </span>
            </div>
            <div className="navbar_title">
              ...
              <div className="navbar_button_action">
                ...
                <div
                  className={isShowAll1 ? 'navbar-item2' : 'navbar-item'}
                  onClick={() => handleIsShowAll1()}
                >
                  <img src={isShowAll1 ? AllViewIcon2 : AllViewIcon} className="imgIcon" />
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            ...
            <div style={{ height: '72.5vh' }}>{isNoteVisible && <NoteComponent type={noteType} />}</div>
          </div>
        </div>
      </div>
    </>
