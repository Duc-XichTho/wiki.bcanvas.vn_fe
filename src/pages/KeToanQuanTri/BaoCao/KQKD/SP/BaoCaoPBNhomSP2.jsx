...
export default function BaoCaoPBNhomSP2({company}) {
    const table = 'BaoCaoPBNhomSP2';
    ...
    useEffect(() => {
        prepareData();
    }, [selectedUnit, isShowAll1, isShowView, currentYearKTQT, currentCompanyKTQT]);
                ...
                <div style={{width: "100%"}}>
                    <div className={css.headerPowersheet}>
                        <div className={css.headerTitle}>
                            <span>Báo cáo KQKD Sản phẩm theo tháng</span>
                        </div>
                    </div>
