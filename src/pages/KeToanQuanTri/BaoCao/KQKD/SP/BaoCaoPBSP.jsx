...
export default function BaoCaoPBSP({company}) {
    const table = 'BaoCaoPBSP';
    ...
    useEffect(() => {
        prepareData();
    }, [selectedMonth, isShowAll1, isShowView, currentMonth]);
                    ...
                    <div className="header-powersheet navbar_kqkd">
                        <div className="navbar_title">
                            <div className="navbar_action">
                                <span className={'title-bc-14-10'}>Báo cáo KQKD Sản phẩm</span>
