...
export default function BaoCaoPBNhomSP({company}) {
    const table = 'BaoCaoPBNhomSP';
    const tableCol = 'BCPBNSPCol';
    const {currentYearKTQT, currentMonthKTQT, loadDataSoKeToan, currentCompanyKTQT, unitDisplay} = useContext(MyContext);
    ...
    const tableStatusButton = 'BCPBNhomSPStatusButton';
    ...
    useEffect(() => {
        prepareData();
    }, [selectedMonth, isShowAll1, currentYearKTQT, isShowView, selectedTypeGroup, currentCompanyKTQT]);
    ...
    useEffect(() => {
        ...
        fetchData().then();
    }, [onGridReady, rowData, table, selectedMonth, isHideEmptyColumns, selectedTypeGroup]);
                ...
                <div style={{width: "100%"}}>
                    <div className={css.headerPowersheet}>
                        <div className={css.headerTitle}>
                            <span>Báo cáo KQKD Sản phẩm</span>
