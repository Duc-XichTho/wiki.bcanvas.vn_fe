...
export default function PlanActualCungKy({company}) {
    const {currentMonth, loadDataSoKeToan, currentUser} = useContext(MyContext)
    const table = 'PlanActualCungKy';
    ...
    const createMonthGroupColumns = (month) => ({
        ...
        children: [
            ...
            createColumn(month, 'Tháng', '_ck', 'Cùng kỳ'),
    ...
    const createCumulative2024Columns = () => ({
        ...
        children: [
            ...
            createColumn(0, 'Tháng', '_ck', 'Cùng kỳ'),
        ...
        if (selectedUnit === 'Total') {
            for (let i = 0; i < rowData.length; i++) {
                ...
                for (let j = 1; j <= 12; j++) {
                    ...
                    let keyCK = `t${j}_ck`;
                    rowData[i][keyCK] = uniqueGroupKH.reduce((total, unit) => {
                        return (
                            total +
                            calculateValueByKmfAndGroupKH(
                                listUnit,
            ...
            for (let i = 0; i < rowData.length; i++) {
                ...
                for (let j = 1; j <= 12; j++) {
                    ...
                    let keyCK = `t${j}_ck`;
                    rowData[i][keyCK] = calculateValueByKmfAndGroupKH(
                        listUnit,
                        groupKmf,
                        listKMF,
                        listSoKeToan,
