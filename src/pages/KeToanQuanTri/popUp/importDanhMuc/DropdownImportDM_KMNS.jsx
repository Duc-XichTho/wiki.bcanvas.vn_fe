...
import {createNewKmf} from "../../../../apisKTQT/kmfService.jsx";
import {createNewKmns, updateKmns} from "../../../../apisKTQT/kmnsService.jsx";

const DropdownImportDM_KMNS = ({table, columnDefs, company, data, title_table, reload, type_setting_group, listGroup,  groupFieldName}) => {
    ...
    const handleImport = async () => {
        try {
            ...
            for (const record of updatedRecords) {
                await updateKmns({ ...record, id: record.id });
            }

            // Then handle new records
            for (const record of newRecords) {
                await createNewKmns(record);
            }
...
export default DropdownImportDM_KMNS;