...
export default function CoChePhanBoKenh({company, call}) {
    ...
    const fetchAllCoCauPhanBo = async () => {
        ...
        try {
            ...
            const filteredData = response.filter((item) => item.type === 'Kênh');
    ...
    async function prepareData() {
        ...
        let rowData = calculateDataView2(data, uniqueUnits, kmfList, 'code', 'kenh2', 'PBKENH', 'teams')
