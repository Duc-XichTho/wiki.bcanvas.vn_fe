...
import { getLuyKeConfig, getLuyKeValue } from './SettingLuyKe/logicLuyKe.js';
...
const KHKDTongHopView = () => {
	...
	const [hasKH, setHasKH] = useState(true);
		...
		<>
			{loadingKHKD ? (
				...
				<div ref={printRef} className={css.KHKDContainer}>
					...
					{hasKH && khkdTH && khkdTH.showBH && dataTT &&
						<>
...
export default KHKDTongHopView;
