...
import { EditIcon, SaveIcon, EditButton } from './ListIcon.jsx';
...
export default function TipTapTitle({ fileNotePad, fetchData }) {
	...
	return (
		<div>
			<div className={css.tiptap}>
				...
				<div className={css.editorWrapperRow}>
					...
					{currentUser?.isAdmin && (
						<div className={css.buttonInline}>
							{/*<Button*/}
							{/*	style={{ fontSize: 16 }}*/}
							{/*	icon={showButton ? <SaveIcon /> : <EditButton />}*/}
							{/*	onClick={showButton ? handleSave : toggleEditMode}*/}
							{/*/>*/}
