...
const ReportOverviewModal = ({ visible, onCancel, onSave, currentOverview = null }) => {
  ...
  // Hiển thị thông tin createAt nếu có
  const renderCreateAtInfo = () => {
    if (!currentOverview?.createAt) return null;
    
    const date = new Date(currentOverview.createAt);
    ...
    return (
      <div style={{
        ...
        📅 Cập nhật lần cuối: {day}/{month}/{year} {hours}:{minutes}
      </div>
    );
  };
