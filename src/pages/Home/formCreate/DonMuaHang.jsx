import css from './DonMuaHang.module.css';
...
const DonMuaHang = () => {
  ...
  const handleCreateDonMuaHang = async () => {
    ...
    try {
      ...
      await updateCard({id: idCard, name: codeDonMuaHang2});
      ...
      setChainTemplate2Selected({
        ...
        data: {
          ...
          selectedTemplate: {
            ...
            cards: chainTemplate2Selected.data.selectedTemplate.cards.map((item) => item.id == idCard ? { ...item, name: codeDonMuaHang2 } : item)
          }
        }
      });
  ...
  const handleUpdateDonMuaHang = async () => {
    try {
      ...
      console.log("dataUpdateDonHang", dataUpdateDonHang);
                ...
                >
                  <Card>
                    <Card.Grid style={gridStyle2}>
                      <Text strong>{codeDonMuaHang2}</Text>
                    </Card.Grid>
                  </Card>
                </ConfigProvider>
              </Flex>
                ...
                {dataDonMuaHangByCode?.trang_thai === 'done'
                  ? (
                    ...
                    >
                      <Card>
                        <Card.Grid style={gridStyle2}>
                          <Text strong>{dayjs(valueNgayMuaHang).format('DD-MM-YYYY')}</Text>
                        </Card.Grid>
                      </Card>
                    </ConfigProvider>
                  ) : (
                    ...
                    >
                      <Card>
                        <Card.Grid style={{ ...gridStyle2, justifyContent: 'flex-start' }}>
                          <Space>
                            <Text strong>{valueDienGiaiInput}</Text>
                          </Space>
                        </Card.Grid>
                      </Card>
                    </ConfigProvider>
