...
const TemplateStepListWorkFlow = ({idTemp, template}) => {
    ...
    const handleAddStep = async () => {
        ...
        const data = await createNewStep(newStep)
    ...
    const handleRenameStep = (value, step) => {
        // if (step.id) {
        //     // Xóa luôn bước có ID khỏi danh sách
        //     // setSteps((prevSteps) =>
    ...
    const [inputValue, setInputValue] = useState(""); // Lưu giá trị nhập vào
    const [inputError, setInputError] = useState(false); // Trạng thái lỗi
        ...
        <>
            ...
            >
                <Select
                    ...
                    value={'Mặc định'} // Giá trị mặc định
                    disabled={true}
                >
...
export default TemplateStepListWorkFlow;
