const AG_GRID_LOCALE_VN = {
    ...
    groups: 'Row Groups',
    rowGroupColumnsEmptyMessage: 'Kéo vào đây để để nhóm theo dòng',
    values: 'Values',
    valueColumnsEmptyMessage: 'Drag here to aggregate',
    pivots: 'Column Labels',
    pivotColumnsEmptyMessage: 'Drag here to set column labels',

    // BCanvasComponent of the Default Group Column
    group: 'Group',
    ...
    autosizeAllColumns: 'Tự động căn chỉnh tất cả các cột',
    groupBy: 'Nhóm theo',
...
export default AG_GRID_LOCALE_VN