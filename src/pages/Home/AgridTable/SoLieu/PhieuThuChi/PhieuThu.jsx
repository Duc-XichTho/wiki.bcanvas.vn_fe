...
import {Phieu_Thu} from "../../../../../Consts/TITLE_HEADER.js";
...
export default function PhieuThu({company = 'HQ'}) {
    const navigate = useNavigate()
    const headerTitle = Phieu_Thu;
    const table = 'PhieuThu';
    const tableCol = 'PhieuThuCol';
    const tableFilter = 'PhieuThuFilter';
    ...
    const [tabSelected, setTabSelected] = useState(ROUTES.PHIEU_THU);
