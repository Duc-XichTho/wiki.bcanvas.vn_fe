...
import {So_Offset, So_Pre_Offset} from "../../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../../actionButton/ActionBookMark.jsx";
import {createOffsetList1} from "../../../../../generalFunction/logicSo/createOffset1List.js";
import MonthSelectBatDauKetThuc from "../../../SelectComponent/MonthSelectBatDauKetThuc.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function SoPreOffset() {
    const headerTitle = So_Pre_Offset;
    const table = 'SoPreOffset';
    const tableCol = 'SoPreOffsetCol';
    const tableFilter = 'SoPreOffsetFilter';
    ...
    const loadData = async (reset = false) => {
        ...
        let rowDataList = []
        rowDataList = createOffsetList1(sktT, listDauKy, startMonth, endMonth, nvs, khs, nccs)
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [
                    ...
                    {
                        field: 'tien',
                        headerName: 'Tiền Offset(Dự kiến)',
                        ...filter(),
                        width: 150,
                        headerClass: 'right-align-important',
                        cellRenderer: (params) => formatMoney(params.value),
