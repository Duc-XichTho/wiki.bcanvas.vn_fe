...
import {createNewHopDong, getAllHopDong} from "../../../../apis/hopDongService.jsx";
...
import {Hop_Dong} from "../../../../Consts/TITLE_HEADER.js";
...
import {HangHoa, HopDong} from "../../../../Consts/MODEL_CALL_API.js";
import PopUpUploadFile from "../../../../components/UploadFile/PopUpUploadFile.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMHopDong() {
    const headerTitle = Hop_Dong;
    const table = 'HopDong';
    const tableCol = 'HopDongCol';
    const tableFilter = 'HopDongFilter';
    ...
    const loadData = async () => {
        ...
        let data = await findRecordsByConditions(HopDong, conditions);
        if (selectedType) {
            data = data.filter(e => e.loai === selectedType);
        }
    ...
    useEffect(() => {
        ...
        fetchCurrentUser();
        loadData();
    }, [selectedCompany, currentYear, selectedType]);
            ...
            try {
                ...
                let updatedColDefs = [
                    ...
                    },
                    {
                        ...
                        cellRenderer: (params) => formatMoney(params.value),
                        valueGetter: (params) => {
                            const giaTri = params.data.gia_tri || 0;
                            const daXuat = params.data.da_xuat || 0;
                            return giaTri - daXuat;
                        },
                        ...filter(),
                    },
                    {
                        field: 'lai_suat_nam',
                        headerName: 'Lãi suất năm',
                        width: 100,
                        ...filter(),
                        cellStyle: {textAlign: 'right'},
                    },
    ...
    const handleAddRow = async () => {
        ...
        await createNewHopDong(newData);
