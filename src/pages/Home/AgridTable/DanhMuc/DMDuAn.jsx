...
import {Du_An} from "../../../../Consts/TITLE_HEADER.js";
import {MyContext} from "../../../../MyContext.jsx";
import {findRecordsByConditions} from "../../../../apis/searchModelService.jsx";
import {DuAn, NhaCungCap} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMDuAn() {
    const headerTitle = Du_An;
    const table = 'DuAn';
    const tableCol = 'DuAnCol';
    const tableFilter = 'DuAnFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(DuAn, conditions);
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [{
                    ...
                    {
                        field: 'quan_ly_da',
                        headerName: 'Quản lý DA',
                        width: 180,
                        ...filter(),
                    },
                    {
                        field: 'phan_tram_hoan_thanh',
