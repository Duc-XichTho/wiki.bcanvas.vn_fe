...
import {createNewDetailLenhSanXuat, getAllDetailLenhSanXuat} from "../../../../apis/detailLenhSanXuatService.jsx";
import {Detail_Lenh_SX} from "../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../actionButton/ActionBookMark.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DetailLenhSanXuat() {
    const headerTitle = Detail_Lenh_SX;
    const table = 'DetailLenhSanXuat';
    const tableCol = 'DetailLenhSanXuatCol';
    const tableFilter = 'DetailLenhSanXuatFilter';
    ...
    const loadData = async () => {
        const data = await getAllDetailLenhSanXuat()
    ...
    const handleAddRow = async () => {
        ...
        await createNewDetailLenhSanXuat(newData);
