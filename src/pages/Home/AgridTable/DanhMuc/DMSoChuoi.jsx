...
import {createNewSoChuoi, getAllSoChuoi} from "../../../../apis/soChuoiService.jsx";
...
import {So_Chuoi} from "../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../actionButton/ActionBookMark.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMSoChuoi({company = "HQ"}) {
    const headerTitle = So_Chuoi;
    const table = 'SoChuoi';
    const tableCol = 'SoChuoiCol';
    const tableFilter = 'SoChuoiFilter';
    ...
    const loadData = async () => {
        const data = await getAllSoChuoi()
        // setRowData(data);
                ...
                let updatedColDefs = [{
                    ...
                    },
                    {
                        ...
                        cellEditorParams: {
                            ...
                            filterList: true,
                            highlightMatch: true,
                            values: listVendor.map((vendor) => vendor.name),
                        },
                    },
                    {
                        field: 'employee',
...

                    {
                        ...
                        cellEditorParams: {
                            ...
                            filterList: true,
                            highlightMatch: true,
                            values: listVas.map((vas) => vas?.name),
                        },
                        ...filterOhther(),
                    },
                    {
...

                    {
                        ...
                        cellEditorParams: {
                            ...
                            filterList: true,
                            highlightMatch: true,
                            values: listProject.map((p) => p?.project_name),
                        },
                    },
    ...
    const handleAddRow = async () => {
        ...
        await createNewSoChuoi(newData);
