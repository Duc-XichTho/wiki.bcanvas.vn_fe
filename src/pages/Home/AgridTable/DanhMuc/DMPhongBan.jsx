...
import {createNewKmf, getAllKmf} from "../../../../apis/kmfService.jsx";
import {getCurrentUserLogin} from "../../../../apis/userService.jsx";
import {createTimestamp, formatMoney} from "../../../../generalFunction/format.js";
import {createNewKmtc, getAllKmtc} from "../../../../apis/kmtcService.jsx";
import {createNewDuAn, getAllDuAn} from "../../../../apis/duAnService.jsx";
import {createNewPhongBan, getAllPhongBan} from "../../../../apis/phongBanService.jsx";
import {DeleteFilterIcon, EllipsisIcon, FilterIcon, SaveTron} from "../../../../icon/IconSVG.js";
...
import {Phong_Ban, San_Pham} from "../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../actionButton/ActionBookMark.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMPhongBan() {
    const headerTitle = Phong_Ban;
    const table = 'PhongBan';
    const tableCol = 'PhongBanCol';
    const tableFilter = 'PhongBanFilter';
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [{
                    ...
                    {
                        field: 'thuoc_ve_BU',
                        headerName: 'Thuộc về BU',
                        width: 150,
                        ...filter(),
                    },
                    {
                        field: 'cap_quan_ly',
                        headerName: 'Cấp quản lý',
                        width: 150,
                        ...filter(),
                    },
                    {
                        field: 'truong_pb',
                        headerName: 'Trưởng phòng ban',
                        width: 150,
                        ...filter(),
                    },
                    {
    ...
    const handleAddRow = async () => {
        ...
        await createNewPhongBan(newData);
