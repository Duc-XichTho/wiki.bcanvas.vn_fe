...
import {createNewTaiSanDauTu} from "../../../../apis/taiSanDauTuService.jsx";
...
import {Tai_San_Dau_Tu} from "../../../../Consts/TITLE_HEADER.js";
import {MyContext} from "../../../../MyContext.jsx";
import {findRecordsByConditions} from "../../../../apis/searchModelService.jsx";
import {TaiSanDauTu} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMTaiSanDauTu() {
    const headerTitle = Tai_San_Dau_Tu;
    const table = 'TaiSanDauTu';
    const tableCol = 'TaiSanDauTuCol';
    const tableFilter = 'TaiSanDauTuFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(TaiSanDauTu, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewTaiSanDauTu(newData);
