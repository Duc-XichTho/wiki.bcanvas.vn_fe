...
import { createNewNhaCungCap, getAllNhaCungCap } from "../../../../apis/nhaCungCapService.jsx";
...
import { Nha_Cung_Cap } from "../../../../Consts/TITLE_HEADER.js";
...
import {CARD, NhaCungCap} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMKhachHang() {
    const headerTitle = Nha_Cung_Cap;
    const table = 'NhaCungCap';
    const tableCol = 'NhaCungCapCol';
    const tableFilter = 'NhaCungCapFilter';
    const key = 'DANHMUC_NCC';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(NhaCungCap, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewNhaCungCap(newData);
