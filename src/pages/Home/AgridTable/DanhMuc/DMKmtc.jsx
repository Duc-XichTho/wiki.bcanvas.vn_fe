...
import {KMTC} from "../../../../Consts/TITLE_HEADER.js";
...
import {HangHoa, Kmtc} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMKmtc() {
    const headerTitle = KMTC;
    const table = 'Kmtc';
    const tableCol = 'KmtcCol';
    const tableFilter = 'KmtcFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(Kmtc, conditions);
