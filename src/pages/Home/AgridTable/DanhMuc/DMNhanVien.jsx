...
import { createNewNhanVien, getAllNhanVien } from "../../../../apis/nhanVienService.jsx";
import PopupDeleteAgrid from "../../popUpDelete/popUpDeleteAgrid.jsx";
import { createDateOnly, createTimestamp, formatDateISO, formatMoney } from "../../../../generalFunction/format.js";
...
import { Nhan_Vien } from "../../../../Consts/TITLE_HEADER.js";
...
import {ChuongTrinh, NhanVien} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMNhanVien() {
    const headerTitle = Nhan_Vien;
    const table = 'NhanVien';
    const tableCol = 'NhanVienCol';
    const tableFilter = 'NhanVienFilter';
    const key = 'DANHMUC_NV';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(NhanVien, conditions);
    ...
    const handleAddRow = async () => {
        const newData = {
            ...
            ngay_sinh: createDateOnly(),
            user_create: currentUser.email,
            company : selectedCompany
        };
        await createNewNhanVien(newData);
