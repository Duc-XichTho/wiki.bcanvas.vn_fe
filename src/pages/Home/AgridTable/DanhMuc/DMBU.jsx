...
import {createNewBusinessUnit, getAllBusinessUnit} from "../../../../apis/businessUnitService.jsx";
...
import {BU} from "../../../../Consts/TITLE_HEADER.js";
...
import {BusinessUnit, NhanVien} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMBU() {
    const headerTitle = BU;
    const table = 'BU';
    const tableCol = 'BUCol';
    const tableFilter = 'BUFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(BusinessUnit, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewBusinessUnit(newData);
