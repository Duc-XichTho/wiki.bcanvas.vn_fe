...
import { LSX_STATUS } from '../../../../CONST.js';
...
import { createDateOnly, createTimestamp } from "../../../../generalFunction/format.js";
...
import { createNewLenhSanXuat, getAllLenhSanXuat } from "../../../../apis/lenhSanXuatService.jsx";
import { Lenh_SX } from "../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../actionButton/ActionBookMark.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function LenhSanXuat() {
    const headerTitle = Lenh_SX;
    const table = 'LenhSanXuat';
    const tableCol = 'LenhSanXuatCol';
    const tableFilter = 'LenhSanXuatFilter';
    ...
    const loadData = async () => {
        const data = await getAllLenhSanXuat()
    ...
    const statusMapping = {
        pending_approval: 'Chưa bắt đầu',
        approved: 'Duyệt LSX',
        ongoing: 'Đang sản xuất',
        completed: 'Hoàn thành',
        cancel: 'Hủy',
    };

    const reverseStatusMapping = {
        'Chưa bắt đầu': LSX_STATUS.PENDING,
        'Duyệt LSX': LSX_STATUS.APPROVE,
        'Đang sản xuất': LSX_STATUS.ONGOING,
        'Hoàn thành': LSX_STATUS.COMPLETED,
        'Hủy': LSX_STATUS.CANCEL,
    };
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [
                    ...
                    {
                        field: 'ngay_dk_hoan_thanh',
                        headerName: 'Ngày dự kiến hoàn thành',
                        width: 190,
                        ...filter(),
                    },
                    {
