...
import {createNewHangHoaLo, getAllHangHoaLo} from "../../../../apis/hangHoaLoService.jsx";
import PopUpForm from "../../formCreate/formCreate.jsx";
import ActionCreate from "../actionButton/ActionCreate.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function HangHoaLo() {
    const table = 'HangHoaLo';
    ...
    const loadData = async () => {
        const data = await getAllHangHoaLo()
        setRowData(data);
        setLoading(false);
    };
...
headerName: 'STT',                        hide: false,
    ...
    return (
        <>
            <div>
                <div className={'headerPowersheet'}>
                    <div className={"headerTitle"}>
                        <span>Danh mục hàng hóa - lô</span>
                    </div>
