...
import {createNewChuSoHuu, getAllChuSoHuu} from "../../../../apis/chuSoHuuService.jsx";
...
import {Chu_So_Huu} from "../../../../Consts/TITLE_HEADER.js";
...
import {ChuSoHuu, KhachHang} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMChuSoHuu() {
    const headerTitle = Chu_So_Huu;
    const table = 'ChuSoHuu';
    const tableCol = 'ChuSoHuuCol';
    const tableFilter = 'ChuSoHuuFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(ChuSoHuu, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewChuSoHuu(newData);
