...
import {createNewLoaiTien, getAllLoaiTien} from "../../../../apis/loaiTienService.jsx";
...
import {Loai_Tien} from "../../../../Consts/TITLE_HEADER.js";
...
import {KhachHang, LoaiTien} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMLoaiTien() {
    const headerTitle = Loai_Tien;
    const table = 'LoaiTien';
    const tableCol = 'LoaiTienCol';
    const tableFilter = 'LoaiTienFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(LoaiTien, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewLoaiTien(newData);
