...
import {createNewTaiKhoanNganHang, getAllTaiKhoanNganHang} from "../../../../apis/taiKhoanNganHangService.jsx";
...
import {Tai_Khoan_Ngan_Hang} from "../../../../Consts/TITLE_HEADER.js";
...
import {NhanVien, TaiKhoanNganHang} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMTkNganHang() {
    const headerTitle = Tai_Khoan_Ngan_Hang;
    const table = 'TkNganHang';
    const tableCol = 'TkNganHangCol';
    const tableFilter = 'TkNganHangFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(TaiKhoanNganHang, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewTaiKhoanNganHang(newData);
