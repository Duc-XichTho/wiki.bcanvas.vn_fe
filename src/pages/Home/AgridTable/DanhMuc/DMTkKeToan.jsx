...
import {createNewTaiKhoan, getAllTaiKhoanFull} from "../../../../apis/taiKhoanService.jsx";
...
import {Tai_Khoan_Ke_Toan} from "../../../../Consts/TITLE_HEADER.js";
import {MyContext} from "../../../../MyContext.jsx";
import {findRecordsByConditions} from "../../../../apis/searchModelService.jsx";
import {NhanVien, TaiKhoan} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMTkKeToan() {
    const headerTitle = Tai_Khoan_Ke_Toan;
    const table = 'TkKeToan';
    const tableCol = 'TkKeToanCol';
    const tableFilter = 'TkKeToanFilter';
    ...
    const loadData = async () => {
        ...
        }        const data = await findRecordsByConditions(TaiKhoan, conditions);
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [
                    ...
                    {
                        field: 'cho_phep_dk',
                        headerName: 'Cho phép định khoản',
                        ...filter(),
                    },
    ...
    const handleAddRow = async () => {
        ...
        await createNewTaiKhoan(newData);
