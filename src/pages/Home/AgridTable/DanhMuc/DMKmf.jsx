...
import {KMF} from "../../../../Consts/TITLE_HEADER.js";
...
import {HangHoa, Kmf} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMKmf() {
    const headerTitle = KMF;
    const table = 'Kmf';
    const tableCol = 'KmfCol';
    const tableFilter = 'KmfFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(Kmf, conditions);
        ...
        const fetchData = async () => {
            try {
                ...
                let updatedColDefs = [
                    ...
                    {
                        field: 'kiem_soat_ngan_sach',
                        headerName: 'Kiểm soát ngân sách',
                        width: 90,
                        editable: true,
                    ...
                    {
                        field: 'duoc_khau_tru_thue',
                        headerName: 'Được khấu trừ thuế',
                        width: 90,
                        editable: true,
                        cellEditor: 'agSelectCellEditor',
                        cellEditorParams: {
