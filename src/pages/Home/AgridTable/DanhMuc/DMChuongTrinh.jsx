...
import {createNewDuAn} from "../../../../apis/duAnService.jsx";
...
import {createNewChuongTrinh, getAllChuongTrinh} from "../../../../apis/chuongTrinhService.jsx";
...
import {Chuong_Trinh, San_Pham} from "../../../../Consts/TITLE_HEADER.js";
import {MyContext} from "../../../../MyContext.jsx";
import {findRecordsByConditions} from "../../../../apis/searchModelService.jsx";
import {ChuongTrinh, NhaCungCap} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMChuongTrinh() {
    const headerTitle = Chuong_Trinh;
    const table = 'ChuongTrinh';
    const tableCol = 'ChuongTrinhCol';
    const tableFilter = 'ChuongTrinhFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(ChuongTrinh, conditions);
    ...
    const handleAddRow = async () => {
        ...
        await createNewChuongTrinh(newData);
