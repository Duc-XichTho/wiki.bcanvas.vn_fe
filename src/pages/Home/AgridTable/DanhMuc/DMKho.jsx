...
import {createNewKho, getAllKho} from "../../../../apis/khoService.jsx";
...
import {Kho} from "../../../../Consts/TITLE_HEADER.js";
...
import {HangHoa, KhoModel} from "../../../../Consts/MODEL_CALL_API.js";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function DMKho() {
    const headerTitle = Kho;
    const table = 'Kho';
    const tableCol = 'KhoCol';
    const tableFilter = 'KhoFilter';
    ...
    const loadData = async () => {
        ...
        const data = await findRecordsByConditions(KhoModel, conditions);
