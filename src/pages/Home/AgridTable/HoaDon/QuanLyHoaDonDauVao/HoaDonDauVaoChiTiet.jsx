...
import { Hoa_Don_Dau_Vao_Chi_Tiet } from '../../../../../Consts/TITLE_HEADER.js';
...
export default function HoaDonDauVaoChiTiet() {
	const headerTitle = Hoa_Don_Dau_Vao_Chi_Tiet;
	const table = 'HoaDonDauVaoChiTiet';
	const tableStatusFilter = 'HoaDonDauVaoChiTiet';
	const tableCol = 'HoaDonDauVaoChiTietCol';
	const tableFilter = 'HoaDonDauVaoChiTietFilter';
