...
import {Hoa_Don_Dau_Vao} from "../../../../../Consts/TITLE_HEADER.js";
import ActionBookMark from "../../actionButton/ActionBookMark.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function QuanLyHoaDonDauVao() {
    const headerTitle = Hoa_Don_Dau_Vao;
    const table = 'HoaDon';
    const tableStatusFilter = 'HoaDonDauVao';
    const tableCol = 'HoaDonDauVaoCol';
    const tableFilter = 'HoaDonDauVaoFilter'
    ...
    const loadData = async () => {
        ...
        const hoaDonData = data
            .filter(item => item.type === HOA_DON_TYPE.DauVao)
            .map(item => {
    ...
    const handleAddRow = async () => {
        await createNewHoaDon({type: HOA_DON_TYPE.DauVao});
