...
import {PBGV2B_TITLE} from "../../../../Consts/TITLE_HEADER.js";
import {createNewPBGV2B, getAllPBGV2B} from "../../../../apis/pbgv2BService.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function PBGV2B() {
    const headerTitle = PBGV2B_TITLE;
    const table = 'PBGV2B';
    const tableCol = 'PBGV2BCol';
    const tableFilter = 'PBGV2BFilter';
