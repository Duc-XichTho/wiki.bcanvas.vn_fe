...
import {PBGV3_TITLE, PBLSX_TITLE} from "../../../../Consts/TITLE_HEADER.js";
import {createNewPBGV3, getAllPBGV3} from "../../../../apis/pbgv3Service.jsx";
import {createNewPBLSX, getAllPBLSX} from "../../../../apis/pblsxService.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function PBLSX() {
    const headerTitle = PBLSX_TITLE;
    const table = 'PBLSX';
    const tableCol = 'PBLSXCol';
    const tableFilter = 'PBLSXFilter';
