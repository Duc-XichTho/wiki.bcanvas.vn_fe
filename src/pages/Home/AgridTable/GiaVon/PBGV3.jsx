...
import {PBGV3_TITLE} from "../../../../Consts/TITLE_HEADER.js";
import {createNewPBGV3, getAllPBGV3} from "../../../../apis/pbgv3Service.jsx";

ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, SetFilterModule]);

export default function PBGV3() {
    const headerTitle = PBGV3_TITLE;
    const table = 'PBGV3';
    const tableCol = 'PBGV3Col';
    const tableFilter = 'PBGV3Filter';
