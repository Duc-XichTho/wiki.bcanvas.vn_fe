...
const SheetColumnModal = ({ sheetId, loadSheetData, onClose, sub_step_id, formStep, DANH_MUC_LIST }) => {
    ...
    const handleSaveFormula = async () => {
        ...
        try {
            ...
            toast.success('Formula saved successfully!', { autoClose: 10});
        } catch (error) {
    ...
    const handleDeleteColumn = async (columnId) => {
        try {
            ...
            toast.success('Column deleted successfully!', { autoClose: 10});
        } catch (error) {
            console.error('Error deleting column:', error);
            toast.error('Failed to delete column. Please try again.', { autoClose: 10});
        }
    };
