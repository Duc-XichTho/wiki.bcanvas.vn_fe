...
import { aiChat, aiGen, webSearchChat } from '../../../apis/botService';
import {
	addMessageToChat,
	...
	updateAiChatHistory,
} from '../../../apis/aiChatHistoryService';
import { getK9ById } from '../../../apis/k9Service';
...
Tóm tắt:`;
	...
	useEffect(() => {
		const fetchTemplates = async () => {
			try {
				const setting = await getSettingByType('TEMPLATE_AI_SETTING');
