...
const CodeColumnConfig = ({ initialConfig = {}, onChange }) => {
  ...
  useEffect(() => {
    onChange && onChange({ columnName, dataType, expression });
    // eslint-disable-next-line
  }, [columnName, dataType, expression]);
  ...
  return (
    <Form layout="vertical" style={{ display: 'flex', flexDirection: 'column', gap: 20, minWidth: 320 }}>
      ...
      <Form.Item label="Biểu thức Javascript" required>
        <Input.TextArea
          placeholder="Nhập biểu thức Javascript (ví dụ: row.amount * 2)"
          value={expression}
...
export default CodeColumnConfig; 