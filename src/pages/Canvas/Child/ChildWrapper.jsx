import css from "./ChildWrapper.module.css";
...
import CongNoPhaiThu from '../Daas/Content/CongNoPhaiThu/CongNoPhaiThu.jsx';
import CongNoPhaiTra from "../Daas/Content/CongNoPhaiTra/CongNoPhaiTra.jsx";

import ChartNhomDVDoanhThu from "../Daas/Charts/ChartNhomDV/ChartNhomDVDoanhThu.jsx";
import ChartNhomDVLoiNhuan from "../Daas/Charts/ChartNhomDV/ChartNhomDVLoiNhuan.jsx";
import ChartNhomDVLaiLo from "../Daas/Charts/ChartNhomDV/ChartNhomDVLaiLo.jsx";
import ChartNhomDVDongGop from "../Daas/Charts/ChartNhomDV/ChartNhomDVDongGop.jsx";
import ChartNhomDVLaiNhom from "../Daas/Charts/ChartNhomDV/ChartNhomDVLaiNhom.jsx";

import ChartNhomSPDoanhThu from "../Daas/Charts/ChartNhomSP/ChartNhomSPDoanhThu.jsx";
import ChartNhomSPLoiNhuan from "../Daas/Charts/ChartNhomSP/ChartNhomSPLoiNhuan.jsx";
import ChartNhomSPLaiLo from "../Daas/Charts/ChartNhomSP/ChartNhomSPLaiLo.jsx";
import ChartNhomSPDongGop from "../Daas/Charts/ChartNhomSP/ChartNhomSPDongGop.jsx";
import ChartNhomSPLaiNhom from "../Daas/Charts/ChartNhomSP/ChartNhomSPLaiNhom.jsx";

import ChartNhomVVDoanhThu from "../Daas/Charts/ChartVV/ChartNhomVVDoanhThu.jsx";
import ChartNhomVVLoiNhuan from "../Daas/Charts/ChartVV/ChartNhomVVLoiNhuan.jsx";
import ChartNhomVVLaiLo from "../Daas/Charts/ChartVV/ChartNhomVVLaiLo.jsx";
import ChartNhomVVDongGop from "../Daas/Charts/ChartVV/ChartNhomVVDongGop.jsx";
import ChartNhomVVLaiNhom from "../Daas/Charts/ChartVV/ChartNhomVVLaiNhom.jsx";

import ChartNhomKenhDoanhThu from "../Daas/Charts/ChartNhomKenh/ChartNhomKenhDoanhThu.jsx";
import ChartNhomKenhLoiNhuan from "../Daas/Charts/ChartNhomKenh/ChartNhomKenhLoiNhuan.jsx";
import ChartNhomKenhLaiLo from "../Daas/Charts/ChartNhomKenh/ChartNhomKenhLaiLo.jsx";
import ChartNhomKenhDongGop from "../Daas/Charts/ChartNhomKenh/ChartNhomKenhDongGop.jsx";
import ChartNhomKenhLaiNhom from "../Daas/Charts/ChartNhomKenh/ChartNhomKenhLaiNhom.jsx";

import ChartChiPhiLuyKe from "../Daas/Charts/ChiPhiLuyKe/ChiPhiLuyKe.jsx";
import ChartDoanhThu_TH_KH_CK from "../Daas/Charts/Chart_TH_KH_CK/Chart_DoanhThu_TH_KH_CK.jsx";
import ChartCF_TH_KH_CK from "../Daas/Charts/Chart_TH_KH_CK/Chart_CF_TH_KH_CK.jsx";
import ChartLN_TH_KH_CK from "../Daas/Charts/Chart_TH_KH_CK/Chart_LN_TH_KH_CK.jsx";
...
import ChartTuoiNoPhaiTra from "../Daas/Charts/ThongKeTuoiNo/PhaiTra.jsx";
import ChartTuoiNoPhaiThu from "../Daas/Charts/ThongKeTuoiNo/PhaiThu.jsx";

import ChartCanDoiTaiChinh from "../Daas/Charts/CanDoiTaiChinh/CanDoiTaiChinh.jsx";
import ChartTonKho from "../Daas/Charts/TonKho/ChartTonKho.jsx";
import ChartTuongDuongTien from "../Daas/Charts/TuongDuongTien/ChartTuongDuongTien.jsx";

import ChartDoanhThuKeHoach from "../Daas/Charts/ChartSoSanhKeHoach/ChartDoanhThuKeHoach.jsx";
import ChartLoiNhuanKeHoach from "../Daas/Charts/ChartSoSanhKeHoach/ChartLoiNhuanKeHoach.jsx";

import ChartCRMThongKe from "../Daas/Charts/ChartCRMThongKe/ChartCRMThongKe.jsx";
import ChartMatrixThongKe from "../Daas/Charts/ChartCRMThongKe/ChartMatrixThongKe.jsx";
...
import BCTien from "../BaoCao/BCTien.jsx";
import BCThueBaoHiem from "../BaoCao/BCThueBaoHiem.jsx";
import DMSoQuanLyTaiSan from "../../Home/AgridTable/DanhMuc/DanhMucSoQuanLyTaiSan.jsx";
import DMSoQuanLyChiTraTruoc from "../../Home/AgridTable/DanhMuc/DanhMucSoQuanLyChiTraTruoc.jsx";
import CDPS from "../../Home/AgridTable/SoLieu/CDPS/CDPS.jsx";
import NhapXuatTon from "../../Home/AgridTable/SoLieu/TonKho/components/NhapXuatTon.jsx";
...
import TienThuTrongKy from "../Daas/Charts/TienThuTrongKy/TienThuTrongKy.jsx";
...
const ChildWrapper = ({ openChildWrapper, setOpenChildWrapper, layoutElementSelected }) => {
  if (!openChildWrapper) return null;
    ...
    >
      <div className={css.popup}>
        <div className={css.header}>
          ...
          <button className={css.closeButton} onClick={() => setOpenChildWrapper(false)}>
            <X size={20} />
          </button>
        </div>
        ...
        <div className={css.container}>
          {(() => {
            switch (layoutElementSelected.child) {
              case 'S101':
              ...
              default:
                return (
                  <span>Component {layoutElementSelected.child}</span>
                );
            }
          })()}
        </div>
