...
import {BC_TIEN, Can_Doi_Phat_Sinh, KHONG_THE_TRUY_CAP} from "../../../Consts/TITLE_HEADER.js";
...
export default function BCTien2() {
    const { companySelect, id } = useParams();
    const headerTitle = BC_TIEN;
    const tableCol = 'BCTienCol2';
    const tableFilter = 'BCTienFilter2';
