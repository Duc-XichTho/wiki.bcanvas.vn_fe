...
import { BC_TIEN, BC_TON_KHO, Can_Doi_Phat_Sinh } from "../../../Consts/TITLE_HEADER.js";
...
export default function BCTonKho() {
    const { companySelect, id } = useParams();
    const headerTitle = BC_TON_KHO;
    const table = 'BCTonKho';
    const tableCol = 'BCTonKhoCol';
    const tableFilter = 'BCTonKhoFilter';
