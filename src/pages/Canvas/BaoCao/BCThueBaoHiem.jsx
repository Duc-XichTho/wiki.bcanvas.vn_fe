...
import { BC_THUE_BAO_HIEM, BC_TIEN, BC_TON_KHO, Can_Doi_Phat_Sinh } from "../../../Consts/TITLE_HEADER.js";
...
export default function BCThueBaoHiem() {
    const { companySelect, id } = useParams();
    const headerTitle = BC_THUE_BAO_HIEM;
    const table = 'BCThueBaoHiem';
    const tableCol = 'BCThueBaoHiem';
    const tableFilter = 'BCThueBaoHiemFilter';
