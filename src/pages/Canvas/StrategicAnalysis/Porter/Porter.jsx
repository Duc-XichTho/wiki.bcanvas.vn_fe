...
import css from './Porter.module.css';
...
export default function Porter() {
	...
	const fetchData = async () => {
		try {
			...
			const parentElementData = data.find(element => element.name === 'PORTER_PARENT');
			setParentElement(parentElementData);

			const childElementsData = data.filter(element => element.name.includes('PORTER_CHILD_'));
