...
import { getNoteChartDataByID, updateNoteChart } from '../../../../../apis/noteChartService.jsx';
import { useParams } from 'react-router-dom';

export default function TiptapHome() {
	...
	const { idNoteChart } = useParams();


	const fetchData = async () => {
		const data = await getNoteChartDataByID(idNoteChart);
		setFileNotepad(data);
	};
