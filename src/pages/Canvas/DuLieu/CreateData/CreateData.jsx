...
export default function CreateData({
	...
	const typeOptions = [
		{ label: 'Bảng Dữ liệu', value: 'Template', note: 'Dữ liệu dạng bảng, có thể tùy biến về kiểu nội dung, số lượng cột, tạo ra các công thức tính toán cơ bản, đính kèm, duyệt' },
		{ label: 'Kho file upload', value: 'FileUpLoad', note: 'Tạo ra kho chứa các file upload bởi người dùng nhằm mục đích tập trung hóa tài liệu số, giúp dễ dàng tra cứu khi cần thiết. Các định dạng hỗ trợ trong kho chứa gồm pdf, excel, word, các định dạng ảnh. 1 kho file có thể chứa nhiều file tài liệu' },
		{ label: 'Văn bản', value: 'Tiptap', note: 'Tạo ra 1 văn bản với định dạng Richtext, cho phép copy paste ảnh, format văn bản với các đề mục, màu sắc... đóng vai trò như 1 tài liệu thông báo, truyền thông các cập nhập mới cho người dùng (ví dụ bản tin nội bộ, cập nhập công việc nhanh). Với Văn bản, người dùng tương tác tạo nội dung trực tiếp trên B-Canvas' },
	];
	...
	return (
		...
		>
			...
			<div style={{ marginBottom: 16 }}>
				...
				>
					<span style={{ width: 20, height: 20, display: 'inline-flex', flex: '0 0 30px', alignItems: 'center', justifyContent: 'center' }}>
