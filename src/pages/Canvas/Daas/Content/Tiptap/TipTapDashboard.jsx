import css from './TipTapDashboard.module.css';
import React, { useEffect, useRef, useState } from 'react';
import { EditorContent } from '@tiptap/react';
import { TiptapToolbar } from './TiptapToolbar';
import { useEditor } from './useEditor';
import { Button, message, Switch } from 'antd';
import { EditIcon, SaveIcon, ShareIcon } from './ListIcon.jsx';
...
export default function TipTapDashboard({ fileNotePad, fetchData }) {
				...
				<div className={css.controlContainer}>
					{!showButton ? (
						<>
							...
							{/*) : (*/}
							{/*	isPlaying ? (*/}
							{/*		<div className={css.buttonWrap} onClick={() => handleSpeaks(fileNotePad.url)}>*/}
