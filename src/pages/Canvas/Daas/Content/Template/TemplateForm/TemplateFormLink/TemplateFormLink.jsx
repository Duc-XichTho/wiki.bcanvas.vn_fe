...
import { Button, DatePicker, Form, Input, InputNumber, Progress, Select, Upload, Radio, message } from 'antd';
import { InboxOutlined } from '@ant-design/icons';
import '../TemplateForm.css';
import { checkMobile } from '../../../../../../../generalFunction/checkMobile.js';
import { createTemplateRow } from '../../../../../../../apis/templateSettingService.jsx';
import { uploadFiles } from '../../../../../../../apisKTQT/uploadImageWikiNoteService.jsx';
import { createNewFile } from '../../../../../../../apis/fileService.jsx';

const { Option } = Select;

const TemplateFormLink = ({
                              fileNoteData,
                              templateColumns,
                              templateData,
                              onSuccess,
                ...
                try {
                    for (let fileItem of selectedFiles) {
                        ...
                        let fileData = {
                            ...
                            type: type,
                            table: `${fileNoteId}_Template`, // Fixed: using templateData.id instead of undefined table
    ...
    return (
        <div className='template-form-container'>
            ...
            >
                ...
                { fileNoteData && fileNoteData?.info?.time != false && renderDateFields()}
...
export default TemplateFormLink;
