...
export default function ChartNhomSPDoanhThu() {
    ...
    const key = "NHOMSP_DOANHTHU_CHART";
        ...
        try {
            ...
            for (let month = 1; month <= (currentMonthCanvas == 0 ? 12 : currentMonthCanvas); month++) {
                ...
                uniqueGroupsSP.forEach((unit) => {
                    let value = caculateSumRevenueWithMonthAndUnitSP(doanh_thu_data_BCSP, mon, unit);
            ...
            let doanhThuSanPham = createSectionData('C1030 - Doanh thu nhóm sản phẩm', data_for_chart_line_BCSP, series_for_chart_line_bcsp, 'C1030 - Doanh thu nhóm sản phẩm');
