...
export default function ChartNhomVVLoiNhuan() {
    ...
    const key = "NHOMVV_LOINHUAN_CHART";
    ...
    const loadChart = async () => {
        try {
            ...
            let loiNhuanVuViec = createSectionData('C1160 - Lợi nhuận vụ việc', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1160 - Lợi nhuận vụ việc')
