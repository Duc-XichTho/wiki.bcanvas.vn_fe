...
export default function ChartNhomKenhDongGop() {
    ...
    const loadChart = async () => {
        try {
            ...
            let dongGopDonVi = createSectionData('C1130 - Đóng góp doanh thu Kênh', percentageDV, [...createNormalisedBarProductGroup(uniqueGroupsDVHasValue)], 'C1130 - Đóng góp doanh thu Kênh');
