...
export default function ChartNhomKenhLoiNhuan() {
    ...
    const key = "NHOMK_LOINHUAN_CHART";
    ...
    const loadChart = async () => {
        try {
            ...
            let loiNhuanNhomKenh = createSectionData('C1120 - Lợi nhuận nhóm Kênh', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1120 - Lợi nhuận nhóm Kênh')
            await setItemInIndexedDB2(key, data_for_chart_line_BCDV);
            setOptions(loiNhuanNhomKenh)
        } catch (error) {
            console.log(error);
