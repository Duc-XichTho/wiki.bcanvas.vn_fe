...
export default function ChartNhomKenhLaiLo() {
    ...
    const loadChart = async () => {
        try {
            ...
            let marginDonVi = createSectionData('C1125 - Lãi lỗ trực tiếp kênh', data_for_chart_line_CMDV, createSeriesCMSP(uniqueGroupsDV), 'C1125 - Lãi lỗ trực tiếp kênh');
