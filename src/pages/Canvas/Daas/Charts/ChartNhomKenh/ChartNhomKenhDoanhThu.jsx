...
import {getPermissionDataNhomBC, getPermissionDataNhomDV} from "../../../getPermissionDataNhomBC.js";
import {KHONG_THE_TRUY_CAP} from "../../../../../Consts/TITLE_HEADER.js";
import NotAccessible from "../../../NotAccessible.jsx";

export default function ChartNhomKenhDoanhThu() {
    ...
    const key = "NHOMK_DOANHTHU_CHART";
    ...
    const loadChart = async () => {
        try {
            ...
            let doanhThuDonVi = createSectionData('C1110 - Doanh thu nhóm kênh', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1110 - Doanh thu nhóm kênh')
