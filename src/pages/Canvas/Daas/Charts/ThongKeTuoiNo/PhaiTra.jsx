    ...
    const loadChart = async () => {
        if (companySelected && companySelected.length > 0) {
            try {
                ...
                hoaDonData = hoaDonData.filter(item => item.type == 'dau_ra');
                ...
                const options = createSectionData('C1220 - Giá trị phải trả theo các ngày trong hạn/ đáo hạn', paymentStatusData, [pieChartSeries], "C1220 - Giá trị phải trả theo các ngày trong hạn/ đáo hạn")
