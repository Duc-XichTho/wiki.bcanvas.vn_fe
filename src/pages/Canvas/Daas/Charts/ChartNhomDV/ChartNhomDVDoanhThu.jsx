...
import {getItemFromIndexedDB2, setItemInIndexedDB2} from "../../../../KeToanQuanTri/storage/storageService";
...
export default function ChartNhomDVDoanhThu() {
    let { tabSelect, companySelect,id } = useParams();
    ...
    const key = "NHOMDV_DOANHTHU_CHART";
    ...
    const loadChart = async () => {
        try {
            ...
            const unValueC5 = keys.filter(key => data_for_chart_line_BCDV.every(obj => (obj[key] == 0 || obj[key] == -Infinity || obj[key] == Infinity || isNaN(obj[key]))));
            ...
            let doanhThuDonVi = createSectionData('C1070-Doanh thu nhóm BU', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1070-Doanh thu nhóm BU')
