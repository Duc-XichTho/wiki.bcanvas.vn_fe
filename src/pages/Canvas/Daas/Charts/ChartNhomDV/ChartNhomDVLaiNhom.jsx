...
export default function ChartNhomDVLaiNhom() {
    ...
    const key = "NHOMDV_LAINHOM_CHART";
    ...
    const loadChart = async () => {
        try {
            ...
            let loiNhuanDonVi = createSectionData('C1100 - Tỷ lệ lãi nhóm BU', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1100 - Tỷ lệ lãi nhóm BU')
