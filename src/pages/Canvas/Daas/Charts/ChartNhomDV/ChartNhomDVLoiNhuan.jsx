...
export default function ChartNhomDVLoiNhuan() {
        ...
        try {
            ...
            for (let month = 1; month <= (currentMonthCanvas == 0 ? 12 : currentMonthCanvas); month++) {
                ...
                uniqueGroupsDV.forEach((unit) => {
                    let value = caculateSumRevenueWithMonthAndUnitSP(loi_nhuan_data_BCDV, mon, unit);
            ...
            let loiNhuanDonVi = createSectionData('C1080 - Lợi nhuận nhóm BU', data_for_chart_line_BCDV, series_for_chart_line_bcdv, 'C1080 - Lợi nhuận nhóm BU')
