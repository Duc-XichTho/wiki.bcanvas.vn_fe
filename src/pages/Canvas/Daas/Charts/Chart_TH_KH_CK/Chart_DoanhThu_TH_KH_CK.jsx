...
export default function ChartDoanhThu_TH_KH_CK() {
    ...
    const key = "CHART_DOANHTHU_TH_KH_CK";
    ...
    const loadChart = async () => {
        ...
        if (companySelected && companySelected.length > 0) {
            try {
                ...
                let doanhThuTong = createSectionData('C1001 - Doanh thu thực hiện, với kế hoạch và cùng kỳ', doanhThuData, seriesArr, 'C1001 - Doanh thu thực hiện, với kế hoạch và cùng kỳ')
