...
const UpdateAnalysisDialog = ({ isOpen, onClose, canvasBot, fetchData }) => {
  ...
  useEffect(() => {
    if (canvasBot) {
      ...
      setSelectedPacks(canvasBot.dataPacks);
      setSelectedNotePacks(canvasBot.notePacks);
      setSelectedTempPacks(canvasBot.tempPacks);
      setSelectedChartTempPacks(canvasBot.tempChartPacks);
      setSelectedKPIPacks(canvasBot.kpiPacks);
    ...
    >
      <div className={css.dialog}>
        <div className={css.header}>
          <h2 className={css.title}>Cập nhật Bot</h2>
        </div>
