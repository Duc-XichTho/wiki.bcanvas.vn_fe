...
import { SelectAIIcon } from "../../../../../icon/IconSVG.js";
        ...
        <div className={css.mainContent}>
            <div className={css.header}>
                <div className={css.headerTitle}>
                    <div className={css.reportHeader}>
                        <span>D{fileNotePad.id}  </span>
                        <span className={css.name}> {fileNotePad.name}</span>
                    </div>
                    <div className={css.info}>
                        {
                            fileNotePad.updated_at &&
                            <span>Last updated {formatDateToDDMMYYYY(fileNotePad.updated_at)} bởi {fileNotePad.user_update}</span>
                        }
            ...
            <div className={css.valueContent}>
                <div className={css.placeholder}>
                    <PreviewComponent data={fileNotePad} onClose={() => setSelectedTapCanvas('')} />
                </div>
            </div>
